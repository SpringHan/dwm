...
static const char *fonts[]          = { "Monego:size=15" };
static const char dmenufont[]       = "Monego:size=10";
...
/* tagging */
static const char *tags[] = { "Oth", "Cod", "Web", "Dra", "Vid", "Mus", "Pla", "Stu" , "Mor" };
...
static const char *sudoranger[] = { "st", "sudo", "-E", "ranger", NULL };
...
static const char *upvol[] = { "pactl", "set-sink-volume", "alsa_output.pci-0000_00_1b.0.analog-stereo", "+5%", NULL };
static const char *uponevol[] = { "pactl", "set-sink-volume", "alsa_output.pci-0000_00_1b.0.analog-stereo", "+1%", NULL };
static const char *downvol[] = { "pactl", "set-sink-volume", "alsa_output.pci-0000_00_1b.0.analog-stereo", "-5%", NULL };
static const char *downonevol[] = { "pactl", "set-sink-volume", "alsa_output.pci-0000_00_1b.0.analog-stereo", "-1%", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|Mod1Mask,              XK_s,      spawn,          {.v = sudoranger } },
	...
	{ MODKEY|ControlMask,           XK_a,      spawn,          {.v = uponevol } },
	{ MODKEY|ControlMask,           XK_s,      spawn,          {.v = downonevol } },
